...
class ChatScreen extends StatefulWidget {
  final String overviewTopic;
  final String topicName;
  const ChatScreen({super.key, required this.overviewTopic, required this.topicName});
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        decoration: InputDecoration.collapsed(
                            hintText: "Ask me about ${widget.topicName}",
  ...
  Future<void> sendMessageFCT(
    ...
    try {
      ...
      await chatProvider.sendMessageAndGetAnswers(
          overviewText: widget.overviewTopic,
          msg: msg, 
